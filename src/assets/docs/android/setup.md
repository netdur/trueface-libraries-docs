...
Download [Trueface SDK 3.2.5](https://github.com/netdur/trueface-libraries-docs/releases/tag/v3.2.5) and include AAR file using Gradle, first use Android Studio menu:
