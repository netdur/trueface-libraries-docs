...
Download [Trueface SDK 3.3.1](https://github.com/netdur/trueface-libraries-docs/releases/tag/v3.3.1) and include AAR file using Gradle, first use Android Studio menu:
